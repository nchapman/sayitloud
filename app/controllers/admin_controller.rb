class AdminController < ApplicationController
  ...
  def index
    ...
    @visitor_chart = Gchart.line(:data => [@visitor_counts, @hit_counts], :legend => ["Visitors", "Views"], :size => '625x250', :theme => :keynote, :axis_with_labels => 'x,y', :axis_labels => [@hours.join("|"), "0|#{@visitor_counts.max}"], :bg => 'fff', :max_value => @hit_counts.max)
  end
end
